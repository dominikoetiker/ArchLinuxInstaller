...
prepairingdisk(){
	...
	#-----------------------------------------------------------------------
	substeptitle "(dm-crypt/Encrypting an entire system:) 3.1 Prepairing the disk" "https://wiki.archlinux.org/title/Dm-crypt/Encrypting_an_entire_system#Preparing_the_disk_2"
...
prepairinglogicalvolumes1(){
	# sub steps function----------------------------------------------------
	# prepairs the logical volumes
...
selectmirrors(){
	# main steps function---------------------------------------------------
	# change the mirrorlist with reflector command
	#-----------------------------------------------------------------------
